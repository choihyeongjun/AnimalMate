...
<body>
	...
	<div class="titlediv">
		<h1 class="atitle"> 실시간 채팅 관리</h1>
		<img class="aimg" src="${pageContext.request.contextPath}/images/img/ballon.png"></img>
	</div>
	<div class="template" style="display: none">
		...
		<textarea class="console" rows="10" cols="50"  disabled="disabled" ></textarea>
	</div>
