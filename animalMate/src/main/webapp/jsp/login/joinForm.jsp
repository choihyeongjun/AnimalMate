...
<body>
	...
	<header class="header" align="center">
		<a href="${pageContext.request.contextPath}/jsp/main/mainMenu.jsp"
			target="_blank"> <image
				src="${pageContext.request.contextPath}/jsp/main/images/newlogo.JPG"
				id="logo"> </image>
		</a>
	</header>
	<!-- 회원가입 입력창 -->
	...
	<form class="join_form"
		action="${pageContext.request.contextPath}/joinInsert.do"
		method="post" onsubmit="return formCheck();" enctype="multipart/form-data">
			...
			<div id="content">
				...
				<div>
					...
					<span class="box int_id"> <input type="text" id="id"
						class="int" maxlength="20" name="id" placeholder="아이디 입력">
						<div align="right">
				...
				<div>
					...
					<span class="box int_pass"> <input type="password" id="pw1"
						class="int" maxlength="20" name="pw" placeholder="비밀번호 (8~20자리)">
					</span>
				</div>
				...
				<div>
					<span class="box int_pass_check"> <input type="password"
						id="pw2" class="int" maxlength="20" name="pw2"
				...
				<div>
					...
					<span class="box int_name"> <input type="text" id="name"
						class="int" name="name" maxlength="20" placeholder="이름을 입력해주세요.">
					</span>
				</div>
				<!-- nick NAME -->
				<div>
					...
					<span class="box int_nname"> <input type="text" id="nname"
						class="int" name="nName" maxlength="20" placeholder="닉네임을 입력해주세요.">
					</span>
				</div>
				<!-- 주민등록번호 -->
				<div>
					<h3 class="join_title">
						<label for="zoomin">주민등록번호 </label>
					</h3>
					<span class="box int_zoomin"> <input type="text" class="zoo"
						name="zoomin1" id="zoomin1" maxlength="6"> - <input
						type="password" class="zoo" name="zoomin2" id="zoomin2"
						maxlength="7">
					</span>
				</div>
				<!-- EMAIL -->
				<div>
					...
					<span class="box int_email"> <input type="email" id="email"
						class="int" maxlength="20" name="email" placeholder="이메일 입력">
					</span>
				</div>
				...
				<div>
					...
					<span class="box int_mobile"> <input type="tel" id="mobile"
						class="int" maxlength="20" name="tel" placeholder="전화번호 입력">
					</span>
				</div>
				...
				<div>
					...
					<span class="box int_location"> <input type="text"
						id="location1" class="int" maxlength="100" name="location1"
						placeholder="주소 입력"><br>
					</span> <span class="box int_location"> <input type="text"
						id="location2" class="int" maxlength="100" name="location2"
				...
				<div>
					<h3 class="join_title">
						<label for="phoneNo">프로필 사진</label>
					</h3>
					<span class="box"> <input type="file" id="pic"
						class="int" maxlength="20" name="pic" style="{font-size: 13px}">
					</span>
				</div>
				...
				<div class="btn_area" align="center">
					...
					<button type="button" id="btn_cancel"
						onclick="window.location.href='${pageContext.request.contextPath}/main.do'">취소</button>
					<!-- 메인 페이지로이동 -->
				</div>
				<!-- 가입&취소 버튼 끝 -->
			</div>
