...
<br/>
	...
	<h1>펫 정보수정</h1>
	<div class="row">
		<form id = "frm" name = "frm" action="${pageContext.request.contextPath}/mypetUpdateAction.do" method="post" enctype="multipart/form-data">
			...
			<table class= "table">
				...
				<tr>
					...
					<td colspan=2><textarea id="comm" name="comm" cols="40" rows="4">${pet.comm}</textarea></td>
				</tr>
				<tr>
					<td colspan =4 align=center>
						<input type="submit" value="수정하기">&nbsp;&nbsp;
						<input type="submit" value="삭	제" formaction="${pageContext.request.contextPath}/mypetDeleteAction.do" formmethod="post" formnovalidate="formnovalidate">&nbsp;&nbsp;
