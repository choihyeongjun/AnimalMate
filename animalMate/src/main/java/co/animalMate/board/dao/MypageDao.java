...
public class MypageDao extends DAO {
	...
	private final String SELECT_USER_TRADES = "SELECT TB.*, P.TYPE, P.DETAILTYPE FROM PETCODE T LEFT OUTER JOIN TRADEBOARD TB ON (T.CODE = TB.CODE) LEFT OUTER JOIN PET P ON (T.PETCODE = P.CODE) WHERE TB.BUYER = ? OR TB.SELLER = ?";
