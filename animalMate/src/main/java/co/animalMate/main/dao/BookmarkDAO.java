...
public class BookmarkDAO extends DAO {
	...
	//업데이트
		public void updateBlack(bookMarkVO vo) { 	
			try {
	...
	//블랙리스트 가져오기
	public List<bookMarkVO> selectBlack(bookMarkVO vo){
	...
	public List<bookMarkVO> selectAllBlack(bookMarkVO vo){
		List<bookMarkVO> list = new ArrayList<bookMarkVO>();
		try {
	...
	public List<bookMarkVO> selectSearch(bookMarkVO vo){
		List<bookMarkVO> list = new ArrayList<bookMarkVO>();
		try {
	...
	//멤버리스트 전체를 가져오는 메소드
	public List<bookMarkVO> selectAll(){ 
		List<bookMarkVO> list = new ArrayList<bookMarkVO>();
		try {
	...
	//시터리스트 설렉하기
	public List<bookMarkVO> selectSitterList(){ 
		List<bookMarkVO> list = new ArrayList<bookMarkVO>();
		try {
	...
	//아이디로 단 건 조회
	public bookMarkVO selectById(bookMarkVO vo) { 
		try {
	...
	//업데이트
	public void update(bookMarkVO vo) { 	
		try {
